<template>
  <el-row class="h-100">
    ...
    <el-col :md="6">
      <div v-if="wallet" class="d-flex h-100">
        <div class="my-auto w-100">
          <el-row>
            <el-col :span="-1">
              <h1 class="my-0">Your Balance</h1>
            </el-col>
          </el-row>
          ...
          <el-row class="b-solid br-small mt-3 p-3" justify="space-between">
            <el-col :span="-1"> Total Balance </el-col>

            <el-col :span="-1">
              <strong> {{ wallet.balance }} $HOST </strong>
            </el-col>
          </el-row>
